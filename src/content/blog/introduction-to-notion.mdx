...
<Callout type='audience' heading="Intended audience" text="Anyone who wants to learn how to set up Notion for productivity. In this post, I’ll show you how Notion can help increase your personal productivity, how you can set up your own Notion dashboard, and give you a free template to help you get started."/>
...
<Callout type='definition' text="“Think of it as a notetaking app except way more customizable.”"/>


The Notion website describes it as:

<Callout type='definition' text="Notion is a single space where you can think, write, and plan. Capture thoughts, manage projects, or even run an entire company — and do it exactly the way you want."/>
...
<BlogImage src="/images/intro-to-notion-1.png" alt="Notion homepage" type="screenshot" />
...
<BlogImage src="/images/intro-to-notion-2.png" alt="Notion Dashboard" type="screenshot" />
...
<BlogImage src="/images/intro-to-notion-3.png" alt="Duplicate Notion template" type="screenshot" />
