...
<PostRef link='/posts/what-is-an-ip-address' title='What the heck is an IP Address?' description='In a world where almost everyone has at least one digital device, I’m pretty sure you’ve heard the term “IP address” thrown around quite a bit, but what exactly is it, and why is it so important?'/>
