...
<Image src="/images/risky-text/tcp_ip-model.png" alt="TCP/IP Network Model" caption="TCP/IP Network Model" />
...
<Image src="/images/risky-text/osi-model.png" alt="OSI Network Model" caption="OSI Network Model" />
...
<Image src="/images/risky-text/comparison.png" alt="TCP/IP vs. OSI" caption="TCP/IP vs. OSI" />
...
<Image src="/images/risky-text/risky-text.png" alt="Don't send a risky text" caption="Don't send a risky text" />
...
<LinkCard href='/posts/what-is-an-ip-address' title='What the heck is an IP Address?' description="In a world where almost everyone has at least one digital device, I'm pretty sure you've heard the term IP address thrown around quite a bit, but what exactly is it, and why is it so important?" />
