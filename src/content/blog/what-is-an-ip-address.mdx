...
subheading: The non-technical version
excerpt: In a world where almost everyone has at least one digital device, I’m pretty sure you’ve heard the term “IP address” thrown around quite a bit, but what exactly is it, and why is it so important?
date: July 6, 2024
tag: Network Engineering
category: networking
coverImage: '/images/ip-address/chaos.gif'
---
...
<Callout type="quote">An IP address is a unique string of numbers assigned to each device connected to the internet or a network. Think of it as your device’s personal identifier in the vast online world.</Callout>
...
<Image src="/images/ip-address/chaos.gif" alt="Chaos Gif" caption="Chaos Gif" />
...
<Image src="/images/ip-address/ip-address.png" alt="What is an IP Address" caption="What is an IP Address" />
...
<Image src="/images/ip-address/ip-types.png" alt="Types of IP Addresses" caption="Types of IP Addresses" />
...
<LinkCard href='/posts/what-happens-when-you-send-a-risky-text' title='The TCP/IP and OSI Models — What happens when you send that risky text?' description="We've all been there – you're lying on your bed on a Friday night, chronically yearning, and about to send that text message that could change everything." />
