...
<BookRef title="Code - The Hidden Language of Computer Hardware and Software" author="Charles Petzold" link="https://www.goodreads.com/en/book/show/44882" src="/images/books/code.jpeg" description="What do flashlights, the British invasion, black cats, and seesaws have to do with computers? In CODE, they show us the ingenious ways we manipulate language and invent new means of communicating with each other. And through CODE, we see how this ingenuity and our very human compulsion to communicate have driven the technological innovations of the past two centuries."/>

<Callout type='disclaimer' heading="Disclaimer" text="The adding machine we're about to construct may seem rudimentary (think 1800s technology), as we're just starting to unravel these concepts and it will only be capable of adding 8-bit binary numbers."/>

<Callout type='audience' heading="Intended audience" text="To follow along with this tutorial, it's important to have a basic understanding of binary numbers (what they represent and their significance in computing) and logic gates."/>
...
<BlogImage src="/images/adding-machine/1.png" alt="AND Gate" type="diagram" />
...
<BlogImage src="/images/adding-machine/2.png" alt="OR Gate" type="diagram" />
...
<BlogImage src="/images/adding-machine/4.png" alt="NOT Gate" type="diagram" />
...
<BlogImage src="/images/adding-machine/3.png" alt="XOR Gate" type="diagram" />
...
<BlogImage src="/images/adding-machine/5.png" alt="NAND Gate" type="diagram" />
...
<BlogImage src="/images/adding-machine/6.png" alt="NOR Gate" type="diagram" />
