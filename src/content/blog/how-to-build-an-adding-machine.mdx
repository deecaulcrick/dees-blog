...
coverImage: "/images/adding-machine/1.png"
---
...
<BookCard title="Code - The Hidden Language of Computer Hardware and Software" author="Charles Petzold" href="https://www.goodreads.com/en/book/show/44882" cover="/images/books/code.jpeg" quote="What do flashlights, the British invasion, black cats, and seesaws have to do with computers? In CODE, they show us the ingenious ways we manipulate language and invent new means of communicating with each other." />


<Callout type="info" title="Intended audience">To follow along with this tutorial, it's important to have a basic understanding of binary numbers (what they represent and their significance in computing) and logic gates.</Callout>

<Callout type="warning" title="Disclaimer">The adding machine we're about to construct may seem rudimentary (think 1800s technology), as we're just starting to unravel these concepts and it will only be capable of adding 8-bit binary numbers.</Callout>
...
<Image src="/images/adding-machine/1.png" alt="AND Gate" caption="AND Gate" />
...
<Image src="/images/adding-machine/2.png" alt="OR Gate" caption="OR Gate" />
...
<Image src="/images/adding-machine/4.png" alt="NOT Gate" caption="NOT Gate" />
...
<Image src="/images/adding-machine/3.png" alt="XOR Gate" caption="XOR Gate" />
...
<Image src="/images/adding-machine/5.png" alt="NAND Gate" caption="NAND Gate" />
...
<Image src="/images/adding-machine/6.png" alt="NOR Gate" caption="NOR Gate" />
...
<Image src="/images/adding-machine/7.png" alt="Binary Addition table" caption="Binary Addition table" />
...
<Image src="/images/adding-machine/8.png" alt="Comparison between Sum Output and XOR gate" caption="Comparison between Sum Output and XOR gate" />

If you look at the Carry (Output) column, you’ll see that it’s the same as the output for the AND gate.

<Image src="/images/adding-machine/9.png" alt="Comparison between Carry Output and AND gate" caption="Comparison between Carry Output and AND gate" />
...
<Image src="/images/adding-machine/10.png" alt="Half-Adder circuit" caption="Half-Adder circuit" />
...
<Image src="/images/adding-machine/11.png" alt="Half-Adder box" caption="Half-Adder box" />
...
<Image src="/images/adding-machine/12.png" alt="Full-Adder Circuit" caption="Full-Adder Circuit" />
...
<Image src="/images/adding-machine/15.png" alt="Full-Adder Box" caption="Full-Adder Box" />

Here’s our assemblage of eight full adders with each carry-out serving as input to the next Carry In:

<Image src="/images/adding-machine/13.png" alt="8-bit assemblage" caption="8-bit assemblage" />
