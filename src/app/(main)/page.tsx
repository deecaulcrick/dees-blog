    ...
    <div className="container">
      <div className="py-10 px-8 md:px-15 lg:px-30 flex flex-col md:flex-row sm:gap-10 md:gap-30">
        <div className="w-full md:w-[60%]">
          <h2 className="text-theme-orange font-medium text-lg mb-10">Articles and tutorials</h2>
          <PostList />
        </div>
        <div className="w-full md:w-[40%]">
          <h2 className="text-theme-orange font-medium text-lg mb-10">Browse by category</h2>
